...
def rancher_api_call(
    ...
    if http_method.lower() == "get":
        response = httpx.get(rancher_url, headers=headers, verify=SSL_VERIFY)
...
# def register_cluster(cluster_name):
    ...
    response = rancher_api_call(
        rancher_url, request_payload=request_payload, http_method="post"
    )
    ...
    registration_resp = rancher_api_call(
        registration_url, request_payload=registration_payload, http_method="post"
    )
    ...
    registration_manifest_resp = rancher_api_call(
